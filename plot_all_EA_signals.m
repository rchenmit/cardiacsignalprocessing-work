...
for i = 1
    ...
    savestr = strcat(savedir, 'plot_', this_scenario_name, '_',  scenario_labels{i},'_ecgHW','_deviation_EA', ...
            '_scg_velocity', '_ABS_scg_deviation_SMA50');
    ...
    savestr = strcat(savedir, 'plot_', this_scenario_name, '_',  scenario_labels{i},'_ecgHW','_deviation_EA', ...
            '_scg_velocity', '_ABS_scg_deviation_SMA100');
    saveas(gcf, savestr, 'png');
    ...
    savestr = strcat(savedir, 'plot_', this_scenario_name, '_',  scenario_labels{i},'_ecgHW','_deviation_EA', ...
            '_scg_velocity', '_ABS_scg_deviation_SMA200');
    saveas(gcf, savestr, 'png');
    ...
    plot(time_ms_HW(1:downsample_factor_HW:end),scgSt_position(1:downsample_factor_HW:end)/scale_ecgHW/500-4*shift_deviationEA, '-ro')
    plot(time_ms_HW(1:downsample_factor_HW:end),scgPmi_position(1:downsample_factor_HW:end)/scale_ecgHW/500-4*shift_deviationEA, '-bo')
    plot(time_ms_HW,tsmovavg_simple_50_square_scgSt_position/quiescent_cutoff/20-6*shift_deviationEA, '-r*')
    plot(time_ms_HW,tsmovavg_simple_50_square_scgPmi_position/quiescent_cutoff/20-7.5*shift_deviationEA, '-b*')
    plot(time_ms_HW,tsmovavg_tri_50_square_scgSt_position_quiescent/20-6*shift_deviationEA, '-g')
    plot(time_ms_HW,tsmovavg_tri_50_square_scgPmi_position_quiescent/20-7.5*shift_deviationEA, '-g')
    %plot "zeros" for the SCG signals
    plot(time_ms_HW,-[ones(1,length(time_ms_HW))]*2*shift_deviationEA, '-k');
    plot(time_ms_HW,-[ones(1,length(time_ms_HW))]*4*shift_deviationEA, '-k');
    plot(time_ms_HW,-[ones(1,length(time_ms_HW))]*6*shift_deviationEA, '-k');
    ...
    savestr = strcat(savedir, 'plot_', this_scenario_name, '_',  scenario_labels{i},'_ecgHW','_deviation_EA', ...
            '_scg_velocity', '_SQUARE_deviation_SMA50');
    saveas(gcf, savestr, 'png');
    ...
    plot(time_ms_HW(1:downsample_factor_HW:end),scgSt_position(1:downsample_factor_HW:end)/scale_ecgHW/500-4*shift_deviationEA, '-ro')
    plot(time_ms_HW(1:downsample_factor_HW:end),scgPmi_position(1:downsample_factor_HW:end)/scale_ecgHW/500-4*shift_deviationEA, '-bo')
    plot(time_ms_HW,tsmovavg_simple_100_square_scgSt_position/quiescent_cutoff/20-6*shift_deviationEA, '-r*')
    plot(time_ms_HW,tsmovavg_simple_100_square_scgPmi_position/quiescent_cutoff/20-7.5*shift_deviationEA, '-b*')
    plot(time_ms_HW,tsmovavg_tri_100_square_scgSt_position_quiescent/20-6*shift_deviationEA, '-g')
    plot(time_ms_HW,tsmovavg_tri_100_square_scgPmi_position_quiescent/20-7.5*shift_deviationEA, '-g')
    %plot "zeros" for the SCG signals
    plot(time_ms_HW,-[ones(1,length(time_ms_HW))]*2*shift_deviationEA, '-k');
    plot(time_ms_HW,-[ones(1,length(time_ms_HW))]*4*shift_deviationEA, '-k');
    plot(time_ms_HW,-[ones(1,length(time_ms_HW))]*6*shift_deviationEA, '-k');
    ...
    savestr = strcat(savedir, 'plot_', this_scenario_name, '_',  scenario_labels{i},'_ecgHW','_deviation_EA', ...
            '_scg_velocity', '_SQUARE_deviation_SMA100');
    saveas(gcf, savestr, 'png');
    ...
    plot(time_ms_HW(1:downsample_factor_HW:end),scgSt_position(1:downsample_factor_HW:end)/scale_ecgHW/500-4*shift_deviationEA, '-ro')
    plot(time_ms_HW(1:downsample_factor_HW:end),scgPmi_position(1:downsample_factor_HW:end)/scale_ecgHW/500-4*shift_deviationEA, '-bo')
    plot(time_ms_HW,tsmovavg_simple_200_square_scgSt_position/quiescent_cutoff/20-6*shift_deviationEA, '-r*')
    plot(time_ms_HW,tsmovavg_simple_200_square_scgPmi_position/quiescent_cutoff/20-7.5*shift_deviationEA, '-b*')
    plot(time_ms_HW,tsmovavg_tri_200_square_scgSt_position_quiescent/20-6*shift_deviationEA, '-g')
    plot(time_ms_HW,tsmovavg_tri_200_square_scgPmi_position_quiescent/20-7.5*shift_deviationEA, '-g')
    %plot "zeros" for the SCG signals
    plot(time_ms_HW,-[ones(1,length(time_ms_HW))]*2*shift_deviationEA, '-k');
    plot(time_ms_HW,-[ones(1,length(time_ms_HW))]*4*shift_deviationEA, '-k');
    plot(time_ms_HW,-[ones(1,length(time_ms_HW))]*6*shift_deviationEA, '-k');
    ...
    savestr = strcat(savedir, 'plot_', this_scenario_name, '_',  scenario_labels{i},'_ecgHW','_deviation_EA', ...
            '_scg_velocity', '_SQUARE_deviation_SMA200');
    saveas(gcf, savestr, 'png');
end
